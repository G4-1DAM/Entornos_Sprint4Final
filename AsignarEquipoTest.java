...
class AsignarEquipoTest {
	...
	/*
	 * Asignar jugador que exista, pero su nombre sea inválido (podeis poner
	 * cualquier nombre no válido, porque ya se prueba todas las combinaciones
	...
	/*
	 * Asignar jugador que exista, pero no tenga nombre (es decir, habéis creado el
	 * jugador pero no habéis puesto el nombre con setnombre)
	 */
	@Test
	...
	/*
	 * Asignar jugador que exista, pero su edad sea inválida (podeis poner cualquier
	 * edad no válida, porque ya se prueba todas las combinaciones posibles en el
	 * anterior)
	 */
	@Test
	...
	/*
	 * Asignar jugador que exista, pero no tenga edad(es decir, habéis creado el
	 * jugador pero no habéis puesto el nombre con setedad)
	 */
	@Test
	...
	/*
	 * Asignar jugador que exista, pero su idioma sea inválido (podeis poner
	 * cualquier idioma no válido, porque ya se prueba todas las combinaciones
	 * posibles en el anterior)
	 */
	@Test
	...
	/*
	 * Asignar jugador que exista, pero no tenga idioma(es decir, habéis creado el
	 * jugador pero no habéis puesto el idioma con setIdioma)
	 */
	@Test
